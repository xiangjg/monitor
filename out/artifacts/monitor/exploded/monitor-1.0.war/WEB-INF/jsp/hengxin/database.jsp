                                ...
                                <c:forEach items="${dbList}" var="db" varStatus="vs">
                                    <tr>
                                        <td class='center' style="width: 30px;">
                                            <label><input type='checkbox' name='ids' value="${db.db_id }"/><span class="lbl"></span></label>
                                        </td>
                                        <td>${db.address }</td>
                                        <td><a>${db.purpose }</a></td>
                                        <td>${db.area }</td>
                                        <td>${db.house_type }</td>
                                        <td>${db.floor }</td>
                                        <td>${db.build_year }</td>
                                        <td>
                                            <div class='hidden-phone visible-desktop btn-group'>
                                                <a class='btn btn-mini btn-info' title="编辑" onclick="editUser('${db.db_id }');"><i class='icon-edit'></i></a>

                                                 <a class='btn btn-mini btn-danger' title="删除" onclick="delUser('${db.db_id }');"><i class='icon-trash'></i></a>
